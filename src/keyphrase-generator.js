// Keyphrase Generator - Browser-compatible implementation
// Using a word list similar to BIP39/niceware for memorable keyphrases

// Common word list (256 words for 8-bit selection)
const WORD_LIST = [
  ...
  'image', 'imitate', 'immense', 'immune', 'impact', 'implement', 'import', 'important',
  ...
  'pond', 'pony', 'pool', 'poor', 'pop', 'popular', 'portion', 'position',
...
export function generateKeyphrase() {
  try {
    // Generate 6 random words from the word list
    const words = [];
    for (let i = 0; i < 6; i++) {
